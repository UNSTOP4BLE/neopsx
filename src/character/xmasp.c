...
static const CharFrame char_xmasp_frame[] = {
	{XmasP_ArcMain_Idle0, {0,   0, 256, 256}, {130, 182}}, //0 idle 1
	{XmasP_ArcMain_Idle1, {0,   0, 256, 256}, {131, 180}}, //1 idle 2
	{XmasP_ArcMain_Idle2, {0,   0, 256, 256}, {130, 182}}, //2 idle 3
	{XmasP_ArcMain_Idle3, {0,   0, 256, 256}, {127, 183}}, //3 idle 4
	
	{XmasP_ArcMain_LeftA0, {0,   0, 256, 256}, {123, 180}}, //4 left a 1
	{XmasP_ArcMain_LeftA1, {0,   0, 256, 256}, {125, 180}}, //5 left a 2
	{XmasP_ArcMain_LeftB0, {0,   0, 256, 256}, {122, 180}}, //6 left b 1
	{XmasP_ArcMain_LeftB1, {0,   0, 256, 256}, {125, 180}}, //7 left b 2
	
	{XmasP_ArcMain_DownA0, {0,   0, 256, 256}, {120, 180}}, //8 down a 1
	{XmasP_ArcMain_DownA1, {0,   0, 256, 256}, {122, 180}}, //9 down a 2
	{XmasP_ArcMain_DownB0, {0,   0, 256, 256}, {121, 180}}, //10 down b 1
	{XmasP_ArcMain_DownB1, {0,   0, 256, 256}, {123, 180}}, //11 down b 2
	
	{XmasP_ArcMain_UpA0, {0,   0, 256, 256}, {117, 180}}, //12 up a 1
	{XmasP_ArcMain_UpA1, {0,   0, 256, 256}, {120, 180}}, //13 up a 2
	{XmasP_ArcMain_UpB0, {0,   0, 256, 256}, {117, 180}}, //14 up b 1
	{XmasP_ArcMain_UpB1, {0,   0, 256, 256}, {119, 180}}, //15 up b 2
	
	{XmasP_ArcMain_RightA0, {0,   0, 256, 256}, {110, 180}}, //16 right a 1
	{XmasP_ArcMain_RightA1, {0,   0, 256, 256}, {110, 180}}, //17 right a 2
	{XmasP_ArcMain_RightB0, {0,   0, 256, 256}, {110, 180}}, //18 right b 1
	{XmasP_ArcMain_RightB1, {0,   0, 256, 256}, {110, 180}}, //19 right b 2
};
