...
void Back_week2a_DrawBG(StageBack *back)
{
	Back_week2a *this = (Back_week2a*)back;
...
void Back_week2a_Free(StageBack *back)
{
	Back_week2a *this = (Back_week2a*)back;
...
StageBack *Back_Week2a_New(void)
{
	//Allocate background structure
	Back_week2a *this = (Back_week2a*)Mem_Alloc(sizeof(Back_week2a));
	if (this == NULL)
		return NULL;
	...
	this->back.draw_bg = Back_week2a_DrawBG;
	this->back.free = Back_week2a_Free;
	
	//Load background textures
	IO_Data arc_back = IO_Read("\\WEEK2A\\BACK.ARC;1");
