...
void Back_week1_DrawBG(StageBack *back)
{
	...
	week1_Henchmen_Draw(this,  FIXED_DEC(50,1) - fx, FIXED_DEC(30,1) - fy);
	week1_Henchmen_Draw(this, FIXED_DEC(150,1) - fx, FIXED_DEC(30,1) - fy);
	week1_Henchmen_Draw(this, FIXED_DEC(250,1) - fx, FIXED_DEC(30,1) - fy);
...
StageBack *Back_Week1_New(void)
{
	...
	this->arc_hench = IO_Read("\\WEEK1\\HENCH.ARC;1");
