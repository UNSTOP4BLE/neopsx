...
void Back_Week5_DrawBG(StageBack *back)
{
	...
	static const struct Back_Week5_LowerBop
	{
		...
		{{0, 0, 106, 105}, {FIXED_DEC(-150,1), FIXED_DEC(-30,1), FIXED_DEC(107,1), FIXED_DEC(105,1)}}, 
		{{175, 3, 74, 151}, {FIXED_DEC(123,1), FIXED_DEC(-67,1), FIXED_DEC(74,1), FIXED_DEC(151,1)}}, 
		{{108, 0, 45, 137}, {FIXED_DEC(60,1), FIXED_DEC(-70,1), FIXED_DEC(45,1), FIXED_DEC(137,1)}}, 
		{{151, 0, 23, 137}, {FIXED_DEC(100,1), FIXED_DEC(-70,1), FIXED_DEC(23,1), FIXED_DEC(137,1)}}, 
		{{0, 109, 41, 139}, {FIXED_DEC(197,1), FIXED_DEC(-109,1), FIXED_DEC(41,1), FIXED_DEC(191,1)}}, 
	};
	...
	static const struct Back_Week5_LowerBop2
	{
		...
		{{0, 0, 197, 181}, {FIXED_DEC(-390,1), FIXED_DEC(-120,1), FIXED_DEC(197,1), FIXED_DEC(181,1)}},
		//done^^^^^^^^
	};
