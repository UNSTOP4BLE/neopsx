	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{NULL, StageId_1_4, "", {"TUTORIAL", NULL, NULL}},
				{"1", StageId_1_1, "", {"BOPEEBO", "FRESH", "DADBATTLE"}},
				{"2", StageId_2_1, "", {"SPOOKEEZ", "SOUTH", "ILLUSION"}},
				{"3", StageId_3_1, "", {"PICO", "PHILLY", "BLAMMED"}},
				{"4", StageId_4_1, "", {"SATIN PANTIES", "HIGH", "MILF"}},
				{"5", StageId_5_1, "", {"COCOA", "EGGNOG", "HALLUCINATION"}},
			};
			...
			Gfx_DrawRect(&name_bar, 171, 86, 236);
